...
from Quantitative_exploratory_data_anaylsis import ecdf as ecdf
...
print(bernoulli_trials(50, 0.15))
...
# The number r of hads in 4 coin flips withprob 0.5

samples = np.random.binomial(60, 0.01, size=10000)
...
#poisson CDF
samples1 = np.random.poisson(6, size=10000)

x, y = ecdf(samples1)
_ = plt.plot(x, y, marker='.', linestyle='none')
_ = plt.margins(0.02)
_ = plt.xlabel('numeber of successess')
_ = plt.ylabel('CDF')
#plt.show()
